...
vim.api.nvim_create_user_command("SetGermanSpellFeature", function()
	vim.cmd(":setlocal spell spelllang=de")
	setCmpDictionaryByCurrentLanguages({ "de" })
end, { desc = "Enable german spelling features" })

vim.api.nvim_create_user_command("SetEnglishSpellFeatureSpellFeature", function()
	vim.cmd(":setlocal spell spelllang=us")
	setCmpDictionaryByCurrentLanguages({ "us" })
end, { desc = "Enable english spelling features" })
